...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-1908731-YNB/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog -sv /opt/Xilinx/Vivado/2020.2/data/ip/xpm/xpm_memory/hdl/xpm_memory.sv
      rt::read_verilog {
      ./.Xil/Vivado-1908731-YNB/realtime/blk_mem_gen_0_stub.v
      ./.Xil/Vivado-1908731-YNB/realtime/KeyboardCtrl_0_stub.v
    ...
    set rt::SDCFileList ./.Xil/Vivado-1908731-YNB/realtime/tetris_synth.xdc
    rt::sdcChecksum
    set rt::top tetris
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-1908731-YNB/"
